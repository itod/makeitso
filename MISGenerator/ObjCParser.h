...
enum {
    ...
    OBJCPARSER_TOKEN_KIND_AT = 39,
    OBJCPARSER_TOKEN_KIND_MIS_ONE_TO_ONE = 40,
    OBJCPARSER_TOKEN_KIND_STAR = 41,
    OBJCPARSER_TOKEN_KIND_STRONG = 42,
    OBJCPARSER_TOKEN_KIND_PLUS = 43,
    OBJCPARSER_TOKEN_KIND_OPEN_BRACKET = 44,
    OBJCPARSER_TOKEN_KIND_COMMA = 45,
    OBJCPARSER_TOKEN_KIND_COPY = 46,
    OBJCPARSER_TOKEN_KIND_RETAIN = 47,
    OBJCPARSER_TOKEN_KIND_MIS_ONE_TO_MANY = 48,
    OBJCPARSER_TOKEN_KIND_CLOSE_BRACKET = 49,
    OBJCPARSER_TOKEN_KIND_MINUS = 50,
    OBJCPARSER_TOKEN_KIND_STRUCT = 51,
    OBJCPARSER_TOKEN_KIND_CARET = 52,
    OBJCPARSER_TOKEN_KIND_TYPEDEF = 53,
    OBJCPARSER_TOKEN_KIND_UNION = 54,
    OBJCPARSER_TOKEN_KIND_READWRITE = 55,
    OBJCPARSER_TOKEN_KIND_INTERFACE = 56,
    OBJCPARSER_TOKEN_KIND_PROTOCOL = 57,
};
